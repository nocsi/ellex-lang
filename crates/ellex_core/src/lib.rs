...
pub mod turtle;
pub mod cached_ast;
pub mod optimized_runtime;
pub mod benchmarks;
pub mod minielixir;
pub mod minielixir_validator;
pub mod minielixir_cached_runtime;
pub mod ellex_minielixir_bridge;
...
pub use cached_ast::{CachedStatement, CacheStats, VariableCache, FunctionCallCache};
pub use optimized_runtime::{OptimizedEllexRuntime, PerformanceMetrics};
pub use benchmarks::{BenchmarkSuite, BenchmarkResults, MemoryBenchmark, MemoryUsage};
pub use minielixir::{MiniElixirExpr, MiniElixirInterpreter, EvaluationContext};
pub use minielixir_validator::MiniElixirValidator;
pub use minielixir_cached_runtime::{CachedMiniElixirRuntime, CachedRuntimeStats, CacheAnalysis};
pub use ellex_minielixir_bridge::EllexMiniElixirBridge;
...
pub fn friendly_error_message(error: &EllexError) -> String {
    match error {
        ...
        EllexError::NotYetImplemented { feature } => {
            format!("🚧 This feature isn't ready yet: {}", feature)
        }
    }
}
