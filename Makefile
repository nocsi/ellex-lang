.PHONY: help setup build test clean dev docs install release fmt clippy check bench wiki-build
...
build: ## Build all components including marketing wiki
...
wiki-build: ## Build the marketing wiki site with diagram rendering
	@echo "🌐 Building marketing wiki..."
	@cd marketing-wiki && npm install && npm run build
	@echo "✅ Marketing wiki built successfully."
